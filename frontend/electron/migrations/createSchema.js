...
export function createSchema() {
    ...
    db.exec(`
        CREATE TABLE IF NOT EXISTS dictionary (
            ...
            num_word_forms TEXT DEFAULT [],
            noun_word_forms TEXT DEFAULT [],
            verb_word_forms TEXT DEFAULT [],
            adj_word_forms TEXT DEFAULT [],
            adv_word_forms TEXT DEFAULT [],
            adp_word_forms TEXT DEFAULT [],
            conj_word_forms TEXT DEFAULT [],
            part_word_forms TEXT DEFAULT [],
            pron_word_forms TEXT DEFAULT [],
            interj_word_forms TEXT DEFAULT [],
            affix_word_forms TEXT DEFAULT [],
            clitic_word_forms TEXT DEFAULT [],
